...
-- lvim.keys.normal_mode["<leader>dq"] = ":call vimspector#Reset()<CR>"
-- lvim.keys.normal_mode["<leader>dc"] = ":call vimspector#Continue()<CR>"
-- lvim.keys.normal_mode["<leader>dd"] = ":call vimspector#Launch()<CR>"
-- lvim.keys.normal_mode["<leader>dt"] = ":call vimspector#ToggleBreakpoint()<CR>"
...
-- lvim.keys.normal_mode["<leader>dk"] = "<Plug>VimspectorStepOut"
-- lvim.keys.normal_mode["<leader>dl"] = "<Plug>VimspectorStepInto"
-- lvim.keys.normal_mode["<leader>de"] = '<Plug>VimspectorBalloonEval'
